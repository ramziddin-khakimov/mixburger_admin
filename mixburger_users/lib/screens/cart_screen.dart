...
import 'package:mixburger_users/assistantMethods/total_amount.dart';

import 'package:mixburger_users/widgets/design/cart_item_design.dart';
                ...
                return Padding(
                  ...
                  child: Center(
                    child: cartProvider.count == 0
                        ? Container()
                        : Text(
                            "Total Price: ${amountProvider.tAmount.toString() + " sum"}",
